...
public class TestUsuario {
	...
	public static void main(String[] args) {
		...
		u1 = new Usuario("0105093884", "Telmo", "Rocano", "trocano@est.ups.edu.ec", "telmo1997", listel);
		
		t1 = new Telefono(1, "0996664040", "CELULAR", "Claro", u1);
		listel.add(t1);
		t2 = new Telefono(2, "0990515471", "CELULAR", "Movistar", u1);
		listel.add(t2);
		t3 = new Telefono(3, "0990526561", "CELULAR", "CNT", u1);
		listel.add(t3);
		t4 = new Telefono(4, "072266039", "CELULAR", "Etapa", u1);
		listel.add(t4);
		//u1.setTelefonos(listel);
				
		usuarioDAO.create(u1);
		
		System.out.println("--Creaci�n de usuarios \n--"+usuarioDAO.find());
